!function(t) {
    ...
    t.Proj.Projection = t.Class.extend({
        initialize: function(o, e, i) {
            var n = t.Proj._isProj4Obj(o);
            this._proj = n ? o : this._projFromCodeDef(o, e),
            this.bounds = n ? e : i
        },
        project: function(o) {
            var e = this._proj.forward([o.lng, o.lat]);
            return new t.Point(e[0],e[1])
        },
        unproject: function(o, e) {
            var i = this._proj.inverse([o.x, o.y]);
        ...
        _projFromCodeDef: function(t, e) {
            if (e)
                ...
                var i = t.split(":");
                if (i.length > 3 && (t = i[i.length - 3] + ":" + i[i.length - 1]),
                void 0 === o.defs[t])
    ...
    t.Proj.CRS = t.Class.extend({
        ...
        initialize: function(o, e, i) {
            var n, s, r, a;
            if (t.Proj._isProj4Obj(o) ? (s = o,
            n = s.srsCode,
            a = e || {},
            this.projection = new t.Proj.Projection(s,a.bounds)) : (n = o,
            r = e,
            a = i || {},
            this.projection = new t.Proj.Projection(n,r,a.bounds)),
            ...
            this.options.scales)
                ...
                this._scales = [];
                for (var l = this.options.resolutions.length - 1; l >= 0; l--)
                    this.options.resolutions[l] && (this._scales[l] = 1 / this.options.resolutions[l])
            }
            this.infinite = !this.options.bounds
        },
        scale: function(t) {
            var o, e, i, n, s = Math.floor(t);
            return t === s ? this._scales[t] : (o = this._scales[s],
            e = this._scales[s + 1],
            i = e - o,
            n = t - s,
            o + i * n)
        ...
        zoom: function(t) {
            var o, e, i, n = this._closestElement(this._scales, t), s = this._scales.indexOf(n);
            return t === n ? s : (e = s + 1,
            o = this._scales[e],
            void 0 === o ? 1 / 0 : (i = o - n,
            (t - n) / i + s))
        ...
        R: t.CRS.Earth.R,
        _closestElement: function(t, o) {
            for (var e, i = t.length; i--; )
                t[i] <= o && (void 0 === e || e < t[i]) && (e = t[i]);
            return e
        }
    }),
    t.Proj.GeoJSON = t.GeoJSON.extend({
        initialize: function(o, e) {
            this._callLevel = 0,
            t.GeoJSON.prototype.initialize.call(this, o, e)
        },
        addData: function(o) {
            var e;
            o && (o.crs && "name" === o.crs.type ? e = new t.Proj.CRS(o.crs.properties.name) : o.crs && o.crs.type && (e = new t.Proj.CRS(o.crs.type + ":" + o.crs.properties.code)),
            void 0 !== e && (this.options.coordsToLatLng = function(o) {
                var i = t.point(o[0], o[1]);
    ...
    t.Proj.ImageOverlay = t.ImageOverlay.extend({
        initialize: function(o, e, i) {
            t.ImageOverlay.prototype.initialize.call(this, o, null, i),
            this._projectedBounds = e
        },
        _animateZoom: function(o) {
            var e = this._map.getZoomScale(o.zoom)
        ...
        _reset: function() {
            var o = this._map.getZoom()
              ...
              , n = i.getSize();
            t.DomUtil.setPosition(this._image, i.min),
            this._image.style.width = n.x + "px",
            this._image.style.height = n.y + "px"
        },
        _projectedToNewLayerPoint: function(t, o, e) {
            var i = this._map.getSize()._divideBy(2)
              , n = this._map.project(e, o)._subtract(i)._round()
              , s = n.add(this._map._getMapPanePos());
            return this._transform(t, o)._subtract(s)
        },
        _transform: function(t, o) {
